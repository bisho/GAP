...
/**
 * This class generates HOTP codes.
 * See RFC 4226: http://tools.ietf.org/html/rfc4226
 *
 * @author Guillermo Pérez <bishillo@gmail.com>
 */
class GAP_HOTPGenerator {
	const BLOCKSIZE = 64;

	/**
	 * Returns the HOTP code for the given shared secret key and
	 ...
	 * @return int
	 */
	public function getHOTPCode($rawKey, $timeChallenge) {
